...
{
    public class DOMaster_Consultant
    {
        ...
        public DOMaster_Consultant(SqlDataReader dr)
        {
            dr.Read();
        ...
        public DOMaster_Consultant(int ConsultantID, int EmployeeID, DateTime CreatedDate, int Flag)
        {
